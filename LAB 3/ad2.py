...
def encrypt_message(public_key, message):
    # Step 1: Derive a shared secret from the public key (use the x-coordinate of the curve point)
...
def decrypt_message(private_key, iv, salt, ciphertext):
    # Step 1: Derive the shared secret using the private key (use x-coordinate of the curve point)
